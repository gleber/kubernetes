...
replace github.com/google/cadvisor => github.com/google/cadvisor v0.37.0
...
replace github.com/oklog/ulid/v2 => github.com/oklog/ulid/v2 v2.0.2
...
replace github.com/opencontainers/runc => github.com/opencontainers/runc v1.0.0-rc91.0.20200707015106-819fcc687efb
...
replace github.com/pborman/getopt => github.com/pborman/getopt v0.0.0-20170112200414-7148bc3a4c30
...
replace golang.org/x/net => golang.org/x/net v0.0.0-20200707034311-ab3426394381
...
replace golang.org/x/sys => golang.org/x/sys v0.0.0-20200622214017-ed371f2e16b4
...
replace sigs.k8s.io/apiserver-network-proxy/konnectivity-client => sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.0.9

replace sigs.k8s.io/kustomize => sigs.k8s.io/kustomize v2.0.3+incompatible

replace sigs.k8s.io/structured-merge-diff/v4 => sigs.k8s.io/structured-merge-diff/v4 v4.0.1
